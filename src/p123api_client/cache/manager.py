...
class CacheManager:
    ...
    def __init__(self, config: Optional[CacheConfig] = None):
        ...
        self.storage = SQLiteStorage(
            str(self.config.db_path_expanded),
    ...
    def put(self, endpoint: str, params: Dict[str, Any], 
            data: Any, force_ttl: Optional[int] = None) -> bool:
        ...
        try:
            ...
            expires_at = (
                ...
                timedelta(seconds=force_ttl)
            ) if force_ttl else self._calculate_next_refresh()
