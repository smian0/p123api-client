...
from p123api_client.cache import CacheConfig, cached_api_call
from p123api_client.models.enums import ScreenType, ScreenMethod
from p123api_client.screen_run import ScreenRunAPI, CachedScreenRunAPI
                    ...
                    try:
                        if isinstance(data_blob, str):
                            if data_blob.startswith('PICKLE:'):
                                ...
                                if isinstance(json_data, dict) and "columns" in json_data and "rows" in json_data:
